...
public final class ThreadPostServiceUtils {
    ...
    static ThreadPost createThreadPostFromModel(ThreadPostModel threadPostModel, ForumThread forumThread, List<PostContent> postContents, ThreadPost repliedPost) {
        return new ThreadPost(threadPostModel.id, threadPostModel.jid, forumThread, postContents, threadPostModel.userCreate, repliedPost, new Date(threadPostModel.timeCreate));
    }
}
